  ...
  <div class="features-grid">
    ...
    <div class="front">
      ...
      <div>
        ...
        <p>Workers will have the ability to generate a job resume directly from the information in their profile.</p>
      </div>
    </div>
        <div class="back">
    ...
    <div class="front">
      ...
      <div>
        ...
        <p>Allows instant messaging between workers and employers. This will help both parties clarify job details and negotiate terms.</p>
      </div>
    </div>
        <div class="back">
    ...
    <div class="front">
      ...
      <div>
        ...
        <p>An AR portfolio lets employers scan a QR code to instantly view videos or images of a worker's projects in augmented reality.</p>
      </div>
    </div>
        <div class="back">
    ...
    <div class="front">
      ...
      <div>
        ...
        <p>During registration, workers are prompted to upload certifications, which are then marked as pending for Manggagawang Pinoy to approve or reject.</p>
      </div>
    </div>
        <div class="back">
