            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="stat-card p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="stat-icon" style="background: linear-gradient(135deg, var(--info-color), #8b5cf6)">
                        ...
                        <div class="application-card">
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-lg-4 text-lg-end mt-3 mt-lg-0">
                                    <button class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#viewApplicationDetailsModal">
                    ...
                    <div class="p-4">
                        ...
                        @forelse ($retrievedSavedJobs as $savedJob) 
                            <div class="job-card">
                                <div class="row align-items-center">
                                    <div class="col-12 col-lg-8">
                                        <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-3 mb-2">
                                            <h5 class="job-title mb-0">{{ $savedJob->job->title ?? 'No title' }}</h5>
                                        ...
                                        <div class="job-details d-flex flex-column flex-md-row gap-3">
                                            ...
                                            <span>
                                                ...
                                                Posted: {{ optional($savedJob->job->created_at)->format('M j, Y') ?? 'N/A' }}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-4 text-lg-end mt-3 mt-lg-0">
                                        <div class="d-flex gap-2 justify-content-lg-end flex-wrap">
                                            ...
                                            <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#applyJobModal"
                                                    data-job-title="{{ $savedJob->job->title ?? 'No title' }}"
                                                    data-company-name="{{ $savedJob->job->employer->addressCompany->company_name ?? 'No company' }}"
                                                    data-job-location="{{ $savedJob->job->employer->addressCompany->company_municipality ?? 'No location' }} {{ $savedJob->job->employer->addressCompany->company_province ?? '' }}">
                        ...
                        @empty
                            <div class="text-center py-5">
                                ...
                                <p class="text-muted">Start browsing jobs and save the ones you're interested in!</p>
                            </div>
                        @endforelse
                    </div>
                </div>
...
<div class="modal fade" id="viewApplicationDetailsModal" tabindex="-1" aria-labelledby="viewApplicationDetailsModalLabel" aria-hidden="true">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="modal-detail-item">
                            ...
                            <div class="detail-value">
                                <a href="mailto:mike.rodriguez@metroconstruction.com">mike.rodriguez@metroconstruction.com</a>
                            </div>
                        </div>
                        <div class="modal-detail-item">
                        ...
                        <div class="modal-detail-item">
                            ...
                            <div class="detail-value">Prepare for upcoming interview - Review job requirements and company background</div>
                        </div>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="modal-detail-item">
                            ...
                            <div class="detail-value">Lead construction teams on residential and commercial projects. Oversee daily operations, ensure safety compliance, and manage project timelines.</div>
                        </div>
                        <div class="modal-detail-item">
...
<div class="modal fade" id="viewSavedJobModal" tabindex="-1" aria-labelledby="viewSavedJobModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
    ...
    <button type="submit" class="btn btn-danger"
        ...
        <i class="fas fa-heart-broken me-2"></i>Remove from Saved
                ...
                <button type="button" class="btn btn-success" data-bs-dismiss="modal" onclick="openApplyModal()">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="jobApplicationForm">
                    ...
                    <div class="mb-3">
                     ...
                     <div class="mb-3">
                        <label class="form-label fw-semibold">Tesda certification</label>
                        <input type="file" class="form-control" name="resume" accept=".pdf,.doc,.docx" >
                        <div class="form-text">Accepted formats: PDF, DOC, DOCX (Max 5MB)</div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Cover Letter</label>
                        <textarea class="form-control" name="cover_letter" rows="4" placeholder="Tell us why you're interested in this position and what makes you a great fit..."></textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Additional Information</label>
                        <textarea class="form-control" name="additional_info" rows="3" placeholder="Any additional information you'd like to share..."></textarea>
                    </div>
                    <!-- <div class="mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success" form="jobApplicationForm">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (savedJobModal) {
        savedJobModal.addEventListener('show.bs.modal', function(event) {
            ...
            const jobAdditionalRequirements = button.getAttribute('data-job-addtional-requirements');
            ...
            const reqList = document.getElementById('modal-job-additional-requirements').querySelector('ul');
