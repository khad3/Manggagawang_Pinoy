          ...
          <div class="tesda-logo">
            ...
            <div>
              ...
              <small style="font-size: 0.8rem; opacity: 0.9"
                >Technical Education & Skills Development</small
              >
            </div>
          </div>
          <a
            href="{{ route('applicant.info.homepage.display') }}"
            class="back-btn"
          >
    ...
    <div class="profile-container animate-fade-in">
      ...
      <div class="profile-card">
        ...
        <div class="cover-section">
          <img
            src="https://images.unsplash.com/photo-1493244040629-496f6d136cc3?auto=format&fit=crop&w=1350&q=80"
            alt="Cover Photo"
            class="cover-image"
          />
          ...
          <div class="profile-photo-container">
            <div class="profile-photo">
              ...
              @if(!empty($retrievedProfile->work_background) &&
        ...
        <div class="profile-info">
          <div class="row align-items-center">
            ...
            <div class="col-lg-4 text-lg-end mt-3 mt-lg-0">
              ...
              <button
                class="btn btn-tesda btn-outline-tesda"
                data-bs-toggle="modal"
        ...
        <div class="left-column">
          ...
          <div class="content-card animate-slide-in">
            <div class="card-header-tesda">
              ...
              <div class="dropdown">
                <button
                  class="btn btn-sm btn-tesda btn-primary-tesda dropdown-toggle"
                  data-bs-toggle="dropdown"
                >
  ...
  @foreach($retrievedPortfolio as $portfolio)
    <div class="col-sm-6 col-md-4">
      <div class="portfolio-card position-relative shadow-sm rounded">
        <img
          src="{{ asset('storage/' . $portfolio->sample_work_image) }}"
          alt="{{ $portfolio->sample_work_title }}"
          class="img-fluid portfolio-thumb"
          loading="lazy"
        />
        ...
        <div class="portfolio-caption p-2">
          ...
          <p class="portfolio-tech small text-muted mb-0">{{ $portfolio->sample_work_description }}</p>
        </div>
      </div>
    </div>
  @endforeach
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body text-center p-0">
        <img id="viewSampleWorkModalImage" src="" alt="Portfolio image" class="img-fluid w-100" style="max-height:75vh; object-fit:contain;">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal" id="closeModalBtn">Close</button>

        <!-- Delete Form -->
        <form id="deletePortfolioForm" action="" method="POST" class="d-inline">
          @csrf
          @method('DELETE')
              ...
              @foreach ($retrievedYoutube as $youtube)
                  @php
                      ...
                      if (preg_match('/youtu\.be\/([a-zA-Z0-9_-]+)/', $youtubeUrl, $matches)) {
                           $videoId = $matches[1];
                      } elseif (preg_match('/youtube\.com\/watch\?v=([a-zA-Z0-9_-]+)/', $youtubeUrl, $matches)) {
                           $videoId = $matches[1];
                      }
                  ...
                  @if ($youtube->applicant_id == $applicantId && $embedUrl)
                      <div class="portfolio-item mb-3">
                          <div class="ratio ratio-16x9">
                            <iframe
                                src="{{ $embedUrl }}"
                                title="{{ $youtube->sample_work_title }}"
                                allowfullscreen
          ...
          <div class="content-card animate-slide-in">
            <div class="card-header-tesda">
              ...
              <button
                class="btn btn-sm btn-tesda btn-primary-tesda"
                data-bs-toggle="modal"
    ...
    <div class="d-flex align-items-center justify-content-between mb-3 p-3 border rounded shadow-sm cert-item">
        ...
        <div class="cert-content flex-grow-1">
            ...
            <small class="text-muted">
                Issued: {{ \Carbon\Carbon::parse($certification->certification_date_obtained)->format('F d, Y') }}
            </small>
            <br>
            <span class="badge 
        ...
        <div class="dropdown ms-3">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li>
                    <a href="{{ asset('storage/' . $certification->file_path) }}" target="_blank" class="dropdown-item">
                      <i class="bi bi-eye me-2"></i> View Certificate
                    </a>

                </li>
                <li>
                    <form action="{{ route('applicant.certification.delete', ['id' => $certification->id]) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this certification?');">
                        @csrf
                        @method('DELETE')
              ...
              @foreach ($retrievedPosts as $post) 
                <div class="post-item mb-4">
                  <div class="post-header d-flex justify-content-between align-items-start">
                      <div class="d-flex align-items-center">
                          <div class="post-avatar me-2">
                              @if (!empty($post->workBackground) && !empty($post->workBackground->profileimage_path))
                                  <img src="{{ asset('storage/' . $post->workBackground->profileimage_path) }}" alt="User Avatar" class="rounded-circle" style="width: 40px; height: 40px; object-fit: cover;">
                                @else
                      ...
                      <div>
                      <div class="post-author fw-bold">{{ $post->personalInfo->first_name ?? 'Unknown'  }} {{ $post->personalInfo->last_name ?? '' }}</div>
                      <div class="post-time text-muted small">{{ $post->created_at->diffForHumans() }}</div>
                  </div>
                </div>
                ...
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <li>
                          <a class="dropdown-item text-danger" href="#"><i class="bi bi-trash me-2"></i>Delete</a>
                      </li>
                   </ul>
                </div>
              </div>
              ...
              <div class="post-content mt-2">
                ...
                @if ($post->image_path)
                  <div class="post-image mt-3">
                    <img src="{{ asset('storage/' . $post->image_path) }}" alt="Post Image" class="img-fluid rounded" />
                  </div>
                @endif
              ...
              <div class="post-item">
                ...
                >
                  <div class="input-group mb-2">
                    ...
                    />
                    <button
                      class="btn btn-tesda btn-primary-tesda"
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="mb-3">
                ...
                <textarea
                  name="sample_work_description"
                  class="form-control"
                  rows="3"
                  placeholder="Describe your sample work"
                ></textarea>
              </div>
            </div>
            <div class="modal-footer">
    ...
    <div
      ...
      id="addYoutubeModal"
      tabindex="-1"
      aria-labelledby="addYoutubeModalLabel"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered">
    ...
    <div
      class="modal fade"
      id="uploadCertificationModal"
      tabindex="-1"
      aria-labelledby="uploadCertificationModalLabel"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
                ...
                <select id="certificationSelect" class="form-control" name="certification_program" required>
                    ...
                    <option value="Gas Tungsten Arc Welding (GTAW) NC II">Gas Tungsten Arc Welding (GTAW) NC II</option>
                    <option value="Flux-Cored Arc Welding (FCAW) NC II">Flux-Cored Arc Welding (FCAW) NC II</option>

                    <!-- Electrical & Electronics -->
                    <option value="Electrical Installation & Maintenance NC II">Electrical Installation & Maintenance NC II</option>
                    <option value="Electronics Products Assembly & Servicing NC II">Electronic Products Assembly & Servicing NC II</option>
                    <option value="Computer Systems Servicing NC II">Computer Systems Servicing NC II</option>

                    <!-- HVAC/R -->
                    <option value="Refrigeration and Air Conditioning Servicing NC II">Refrigeration and Air Conditioning Servicing NC II</option>
                ...
                <div id="otherCertInput" style="display: none; margin-top: 10px;">
                    ...
                    <input type="text" name="other_certification_program" class="form-control" id="otherInput" placeholder="Enter your certification">
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    <div
      ...
      tabindex="-1"
      aria-labelledby="viewCertificationModalLabel"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-footer justify-content-between">
            <span class="text-muted"
              >TESDA National Certificate II - Computer Systems Servicing</span
            >
            <button class="btn btn-secondary" data-bs-dismiss="modal">
              Close
            </button>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="mb-3">
            ...
            <input type="email" name="email" class="form-control" value="{{ $retrievedProfile->email }}" required>
          </div>

          <div class="mb-3">
            <label class="form-label">House / Street</label>
            <input type="text" name="house_street" class="form-control" value="{{ $retrievedProfile->personal_info->house_street }}">
          </div>

          <div class="mb-3">
            <label class="form-label">Barangay</label>
            <input type="text" name="barangay" class="form-control" value="{{ $retrievedProfile->personal_info->barangay }}">
          </div>

          <div class="mb-3">
            <label class="form-label">City</label>
            <input type="text" name="city" class="form-control" value="{{ $retrievedProfile->personal_info->city }}">
          </div>

          <div class="mb-3">
            <label class="form-label">Province</label>
            <input type="text" name="province" class="form-control" value="{{ $retrievedProfile->personal_info->province }}">
          </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // When modal closes, clean up backdrop & restore body
...
<script>
// Fixed Portfolio Modal Script - Replace the existing script with this
document.addEventListener('DOMContentLoaded', function () {
    const modalEl = document.getElementById('viewSampleWorkModal');
    const modalImage = document.getElementById('viewSampleWorkModalImage');
    const modalTitle = document.getElementById('viewSampleWorkModalTitle');
    ...
    // Create ONE modal instance
    const bsModal = new bootstrap.Modal(modalEl, { 
        backdrop: true,
        keyboard: true 
    });

    // Handle opening modal when portfolio item is clicked
    document.querySelectorAll('.view-portfolio-btn').forEach(btn => {
        btn.addEventListener('click', function(e) {
            ...
            // Update delete form action if you have portfolio ID
            const portfolioCard = this.closest('.portfolio-card');
            if (portfolioCard && portfolioCard.getAttribute('data-id')) {
                const portfolioId = portfolioCard.getAttribute('data-id');
                deleteForm.action = `/portfolio/${portfolioId}`;
            }
...
// Remove the duplicate/conflicting script at the bottom of your HTML
// Keep only this one script for the portfolio modal
</script>
