            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="fullName" placeholder="Juan Dela Cruz"
                        value = "{{ $retrievedProfiles->personal_info->first_name }} {{ $retrievedProfiles->personal_info->last_name }}">
                </div>
                <div class="form-group">
                    <label for="jobTitle">Trade/Specialization</label>
                    <input type="text" id="jobTitle" placeholder="Master Electrician"
                        value="{{ $retrievedProfiles->work_background->position }}">
                </div>
                <div class="form-group">
                    <label for="email">Email Address</label>
                    <input type="email" id="email" placeholder="juan.delacruz@email.com"
                        value="{{ $retrievedProfiles->email }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="address"
                        placeholder="123 Rizal Street, Barangay San Jose, Quezon City, Metro Manila"
                        value="{{ $retrievedProfiles->personal_info->house_street }} {{ $retrievedProfiles->personal_info->barangay }}, {{ $retrievedProfiles->personal_info->city }} {{ $retrievedProfiles->personal_info->province }}">
                </div>
                <div class="form-group">
                    <label for="yearsExperience">Years of Experience</label>
                    <select id="yearsExperience">
                        <option
                            value="{{ $retrievedProfiles->work_background->work_duration }} {{ $retrievedProfiles->work_background->work_duration_unit }}">
                            Select years of experience</option>
            ...
            <div class="form-section">
                ...
                <div class="two-column">
                    <div class="form-group">
                        ...
                        <textarea id="technicalSkills"
                            placeholder="Electrical wiring and installation, Circuit design and troubleshooting, Motor control systems, PLC programming, Electrical panel assembly"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="equipmentSkills">Tools & Equipment</label>
                        <textarea id="equipmentSkills"
                            placeholder="Multimeter, Oscilloscope, Cable puller, Conduit bender, Power quality analyzer, Hand and power tools"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="softSkills">Professional Skills</label>
                    <textarea id="softSkills"
                        placeholder="Safety compliance (OHSA), Blueprint reading, Project supervision, Quality control, Team leadership, Client communication"></textarea>
                </div>
            </div>
                    ...
                    <div class="experience-item">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="exp-description"
                                placeholder="• Supervised electrical installations for 50+ residential and commercial projects
                    ...
                    <div class="education-item">
                        <div class="form-group">
                            ...
                            <input type="text" class="edu-degree"
                                placeholder="Electrical Installation & Maintenance NCII">
                        </div>
                        <div class="form-group">
                            <label>Institution/Training Center</label>
                            <input type="text" class="edu-institution"
                                placeholder="TESDA Regional Training Center - NCR">
                        </div>
                        <div class="form-group">
            ...
            <div class="resume" id="resumePreview">
                <div class="resume-header">
                    ...
                    <div class="resume-contact">
                        ...
                        <div class="contact-item" id="previewAddress">123 Rizal Street, Barangay San Jose, Quezon City
                        </div>
                ...
                <div class="resume-body">
                    <div class="resume-section" id="objectiveSection">
                        ...
                        <p class="objective-text" id="previewObjective">Dedicated and safety-conscious Master
                            Electrician with 8+ years of experience in residential, commercial, and industrial
                            electrical installations. Seeking to contribute technical expertise and leadership skills to
                            a progressive company while ensuring compliance with all safety regulations and building
                            codes.</p>
                    </div>
                        ...
                        <div id="previewExperiences">
                            <div class="experience-entry">
                                ...
                                <div class="entry-description">
                                    • Supervised electrical installations for 50+ residential and commercial
                                    projects<br>
    ...
    <script>
        ...
        function updatePreview() {
            ...
            document.getElementById('previewAddress').textContent = document.getElementById('address').value ||
                '123 Rizal Street, Barangay San Jose, Quezon City';
            ...
            document.getElementById('previewObjective').textContent = document.getElementById('objective').value ||
                'Dedicated and safety-conscious Master Electrician with 8+ years of experience in residential, commercial, and industrial electrical installations. Seeking to contribute technical expertise and leadership skills to a progressive company while ensuring compliance with all safety regulations and building codes.';
        ...
        function updateSkillsPreview() {
            ...
            const technicalSkills = document.getElementById('technicalSkills').value ||
                'Electrical wiring and installation, Circuit design and troubleshooting, Motor control systems, PLC programming, Electrical panel assembly';
            const equipmentSkills = document.getElementById('equipmentSkills').value ||
                'Multimeter, Oscilloscope, Cable puller, Conduit bender, Power quality analyzer, Hand and power tools';
            const softSkills = document.getElementById('softSkills').value ||
                'Safety compliance (OHSA), Blueprint reading, Project supervision, Quality control, Team leadership, Client communication';
