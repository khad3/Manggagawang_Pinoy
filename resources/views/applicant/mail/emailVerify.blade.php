...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;">
    <div
        ...
        <p style="color: #555555; font-size: 16px; line-height: 1.5;">
            Hi there,<br><br>
            Thank you for registering with <strong>Mangagawang Pinoy</strong>. To complete your registration, please use
        ...
        <p style="color: #555555; font-size: 14px;">
            This code will expire in <strong>10 minutes</strong>. If you did not initiate this request, you can safely
            ignore this email.
        </p>
