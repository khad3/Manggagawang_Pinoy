 ...
 <body>
     ...
     <a-scene embedded arjs="sourceType: webcam;" vr-mode-ui="enabled: false">
         <a-assets>
             <!-- Profile Image -->
             <img id="profilePic"
                 src="{{ $retrievedProfile?->work_background?->profileimage_path
                     ? asset('storage/' . $retrievedProfile->work_background->profileimage_path)
                     : asset('img/workerdefault.png') }}"
     ...
     <svg xmlns='http://www.w3.org/2000/svg' width='1000' height='600' viewBox='0 0 1000 600'>
       ...
       <rect x='0' y='0' width='1000' height='600' fill='%23ffffff'/>
     </svg>">
         ...
         <a-marker preset="hiro">
             ...
             <a-image src="#cardTexture2" width="2.5" height="4" rotation="-90 0 0" position="4 0 0"></a-image>

             <!-- RIGHT SIDE: Logo + Profile Picture -->
             <a-entity rotation="-90 0 0" position="1.5 0.5 -0.3">
                 <!-- Background circle with logo -->
                 <a-circle src="#workerLogo" radius="1.2" position="-0.25 -0.3 -0.40"
                     scale="1.02 1.05 1.6"></a-circle>

                 <!-- Foreground profile picture -->
                 <a-circle src="#profilePic" radius="0.8" position="-0.38 -0.19 -0.35"></a-circle>
             </a-entity>
             ...
             <a-entity rotation="-90 0 0" position="-2.4 0.8 -1.0">
                 ...
                 <!-- Portfolio -->
                 <a-entity rotation="0 0 0" position="5.8 0.2 -0.55">
                     @foreach ($retrievedPortfolio as $key => $portfolio)
                         <a-image src="#portfolio{{ $key }}" width="1.0" height="0.75"
                             position="0 {{ -$key * 1.0 }} 0"
                             open-link="url: {{ asset('storage/' . $portfolio->sample_work_image) }}">
                         </a-image>
                     @endforeach
                 </a-entity>
                 ...
                 <a-text
                     ...
                     width="2.3" color="#ffffff" align="left" position="0.2 -2.2 -0.5"font="mozillavr"
                     wraptext="8"></a-text>
             ...
             <!-- youtube-->
             <a-entity rotation="-90 0 0" position="3.5 0.3 -1.2">
                 @foreach ($retrievedYoutube as $key => $yt)
                     @php
                     ...
                     @if ($videoId)
                         <a-image src="https://img.youtube.com/vi/{{ $videoId }}/hqdefault.jpg" width="1.0"
                             height="0.75" rotation="0 0 0" position="1 {{ -$key * 1.0 }} 0"
