...
<div class="container mt-4">
  ...
  <div class="mb-4 text-start">
    <a href="{{ route('applicant.forum.display') }}" class="btn btn-outline-primary btn-custom">← Back to forum page</a>
    <a href="{{ route('applicant.forum.viewgroupcreator.display') }}" class="btn btn-success btn-custom">View My Created Groups</a>
  </div>
      ...
      <div class="post-card mb-4">
        <div class="post-header">
          ...
          <div class="post-meta">
            @if ($group->personalInfo)
              <p>Created by: <strong>{{ $group->personalInfo->first_name }} {{ $group->personalInfo->last_name }}</strong></p><br>
        ...
        <div class="post-body">
          ...
          <div class="d-flex justify-content-between align-items-center">
            <span class="badge {{ $group->privacy === 'public' ? 'bg-success' : 'bg-info text-dark' }}">
            ...
            <div class="d-flex gap-2">
              @if (!$isMember && !$isCreator)
                <form method="POST" action="{{ route('applicant.forum.joingroup.store') }}">
                  ...
                  <button type="submit" class="btn btn-{{ $group->privacy === 'public' ? 'primary' : 'warning' }} btn-custom">
              ...
              @if ($isMember || $isCreator)
                <a href="{{ route('applicant.forum.joinedgroup.display', $group->id) }}" class="btn btn-success btn-custom">View Group</a>
              @endif
            </div>
          </div>
