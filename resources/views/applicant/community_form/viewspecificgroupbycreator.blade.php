...
<div class="container py-5">
  ...
  <div class="group-banner">
    <div class="d-flex justify-content-between align-items-center">
      ...
      <div>
        <a href="{{ route('applicant.forum.viewgroupcreator.display') }}" class="btn btn-outline-light me-2">← Back</a>
...
<form method="POST" action="{{ route('applicant.forum.groupaddlike.store', ['groupId' => $group->id, 'postId' => $post->id]) }}">
    ...
    <button type="submit" class="btn btn-sm btn-outline-primary me-2">
        👍 Like ({{ $post->likes->count() ?? 0 }})
              ...
              <button class="btn btn-sm btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#comments-{{ $loop->iteration }}">💬 Comments (2)</button>
            </div>
