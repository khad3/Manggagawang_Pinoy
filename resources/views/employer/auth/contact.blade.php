                ...
                <!-- Company Address Section - Cavite Only -->
                  <div class="section-divider">
                      ...
                      <div class="mb-4">
                          ...
                          <input type="text" class="form-control" id="companyname" name="company_name" placeholder="e.g. ABC Construction Company" required />
                      </div>

                      <div class="mb-4">
                          <label for="address" class="form-label">Street Address *</label>
                          <input type="text" class="form-control" id="address" name="complete_address" placeholder="Complete street address" required />
                      </div>

                      <div class="row mb-4">
                          <div class="col-md-6">
                              <label for="city" class="form-label">City / Municipality in Cavite *</label>
                            ...
                            <div class="col-md-3">
                              ...
                              <input type="text" class="form-control" id="zipCode" name="zip_code" placeholder="e.g. 4114" />
                            </div>
                  ...
                  <div class="section-divider">
                    ...
                    <div class="mb-4">
                      <label for="emergencyRelation" class="form-label"
                        >Relationship to Company</label
                      >
                      <select class="form-select" id="emergencyRelation" name="emergency_contact_relationship">
                  ...
                  <div class="section-divider">
                    ...
                    <div class="mb-4">
                      <label for="workHours" class="form-label"
                        >Typical Work Hours</label
                      >
                      <input
                        type="text"
                        class="form-control"
                        name="typical_working_hours"
                        id="workHours"
                        placeholder="e.g. 7:00 AM - 5:00 PM, Monday to Saturday"
                      />
                    </div>

                    <div class="mb-4">
                      <label for="notes" class="form-label"
                        >Special Instructions or Notes</label
                      >
                      <textarea
                        class="form-control"
                        ...
                        id="notes"
                        rows="3"
                        placeholder="Any additional information about your project, location, or requirements..."
                      ></textarea>
                    </div>
