        ...
        <div class="row">
            ...
            <div class="review-card">
              ...
              <div class="card-body">
                <div class="summary-item">
                  ...
                  <div class="small text-muted">{{ $retrievedCompanyAddress->company_complete_address }}</div>
                </div>
                <div class="mt-3">
                  <p class="small">
          ...
          <div class="col-lg-6 mb-4">
            <div class="review-card">
              ...
              <div class="card-body">
                  <div class="summary-item">
                      <strong>{{ $retrievedPersonalInfo->first_name }} {{ $retrievedPersonalInfo->last_name }}</strong>
                  ...
                  <div class="mt-3">
                      ...
                      <div class="small">
                            <strong>Preferred Contact:</strong> {{ $retrievedCommunication->contact_method }}<br />
                  ...
                  <div class="col-md-8">
                    <div class="summary-item">
                      ...
                      <div class="text-muted">
                        {{ $retrievedCompanyAddress->department }} • {{ $retrievedJobDetail->location}}• {{ $retrievedJobDetail->work_type }}
                      </div>
                      <div class="text-muted">
                       {{ $retrievedJobDetail->experience_level }} • ₱{{ $retrievedJobDetail->job_salary }}/month
                      </div>
                    </div>
                    <div class="mt-3">
                      <p class="small">
                        <strong>Job Description:</strong> {{ $retrievedJobDetail->job_description }}

                        <br />
                        <strong>Job Requirements:</strong> {{ $retrievedJobDetail->additional_requirements ?? 'No additional requirements' }}
                      </p>
                    </div>
                  </div>
                  <div class="col-md-4">
                      ...
                      <div class="mt-2">
                         @php
                            $certs = [];
                              ...
                              } elseif (!empty($retrievedJobDetail->none_certifications_qualification)) {
                      ...
                      @php
                          ...
                          if (!empty($retrievedJobDetail->benefits)) {
                              ...
                              if (is_array($decoded)) {
                                  ...
                                  $benefits = array_map('trim', explode(',', $retrievedJobDetail->benefits));
                              }
                          }
                        @endphp 
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-3">
                    <div class="summary-item">
                      ...
                      <div class="text-muted">{{ $retrievedHiringTimeline->hiring_timeline ?? 'No hiring timeline' }}</div>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="summary-item">
                      <strong>Workers Needed</strong>
                      <div class="text-muted">{{ $retrievedWorkerRequirement->number_of_workers }}</div>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="summary-item">
                      <strong>Project Duration</strong>
                      <div class="text-muted">{{ $retrievedWorkerRequirement->project_duration }}</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row mt-3">
                  <div class="col-md-6">
                    ...
                    <div class="mt-1">
                      ...
                      <i class="fas fa-check text-success me-2"></i>{{ $retrievedCertPriority->tesda_priority }}
                ...
                <div class="mt-3">
                  ...
                  @endforeach
                   ...
                   <span class="skill-badge">{{ $retrievedInterviewScreening ->preferred_interview_location }}</span>
        ...
        <div class="row justify-content-center mt-4">
          <div class="col-lg-8">
            ...
            <form action="{{ route('employer.sendVerificationEmail') }}" method="POST">
              ...
              <button type="submit" class="btn btn-success-custom"><i class="fas fa-check-circle me-2"></i>Submit Registration </button>
            </form>
            </div>
          </div>
        </div>
