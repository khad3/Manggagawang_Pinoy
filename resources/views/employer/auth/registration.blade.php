    ...
    <div class="registration-container">
        <div class="container">
            ...
            <div class="text-center mb-5">
                ...
                <p class="lead text-muted">Find TESDA-certified skilled workers and blue collar professionals for your
                    projects</p>
            </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="job_location" class="form-control"
                                            id="location" placeholder="e.g. Manila, Cebu, Davao" required>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" name="none_certifications" value="on"
                                                type="checkbox" id="nonecertification"
                                                onchange="toggleTesdaCerts(this)">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    ...
                                                    <input class="form-check-input" name="job_tesda_certification[]"
                                                        value="Welding (SMAW/GMAW/GTAW)" type="checkbox"
                                                        id="welding">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label fw-bold"
                                                        for="otherCertCheckbox">Other Certification</label>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input"
                                                        name="job_non_tesda_certification[]"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input"
                                                        name="job_non_tesda_certification[]"
                                                        value="Flexible and adaptable" type="checkbox"
                                                        id="flexibility">
