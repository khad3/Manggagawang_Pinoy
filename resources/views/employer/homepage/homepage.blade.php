                        ...
                        <div class="w-100">
                            ...
                            <div class="d-flex gap-3 text-muted small flex-wrap">
                                <span><i class="bi bi-calendar3 me-1"></i><span
                                        id="modalPublicationDate"></span></span>
                    ...
                    <div class="col-lg-6">
                        <div class="card shadow-sm border-0 rounded-4">
                            <div class="card-header bg-light fw-bold">
                                <i class="fas fa-building me-2 text-secondary"></i>Edit Company Name
                            </div>
                            <div class="card-body">
                                <form>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="companyName"
                                            ...
                                            value="TechVision Solutions" placeholder="Enter your company name">
                                    </div>
                    ...
                    <div class="col-12">
                        <div class="card shadow-sm border-0 rounded-4 mt-4">
                            <div class="card-header bg-light fw-bold text-danger">
                                <i class="fas fa-user-slash me-2 text-danger"></i>Delete Account
                            </div>
                            <div class="card-body">
                                <p class="text-muted mb-3">
                                    Deleting your account will remove all your company data, job posts, and applicants.
