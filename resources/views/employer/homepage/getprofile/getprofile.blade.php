...
<a href="{{ route('employer.info.homepage.display') }}" class="back-button"><i class="fas fa-arrow-left"></i> Back</a>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                <div class="candidate-basic-info">
                                    ...
                                    <div class="candidate-role">{{  $retrievedProfile->work_background->position }}<span class="experience-badge">{{  $retrievedProfile->work_background->work_duration }} {{  $retrievedProfile->work_background->work_duration_unit }} experience</span></div>
                                    <div class="candidate-location"><i class="fas fa-map-marker-alt"></i> {{  $retrievedProfile->personal_info->house_street }} {{  $retrievedProfile->personal_info->city }} {{  $retrievedProfile->personal_info->province }} {{  $retrievedProfile->personal_info->zipcode }}</div>
                                </div>
                            </div>
                            <div class="col-auto">
                                    ...
                                    <div class="info-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="info-item">
                                                ...
                                                <span class="info-value">{{ $retrievedProfile->personal_info->house_street }}, {{ $retrievedProfile->personal_info->city }}, {{ $retrievedProfile->personal_info->province }}, {{ $retrievedProfile->personal_info->zipcode }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                           ...
                           @foreach ($retrievedPosts as $post)
                                <div class="col-12">
                                    <div class="card border-0 shadow mb-5 rounded-4 overflow-hidden">
                                        <!-- Header -->
                                        <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-start py-3 px-4">
                                            <div>
                                                <h5 class="fw-semibold text-primary mb-1">
                                                    <i class="fas fa-pen-nib me-2"></i> Applicant Post
                                                </h5>
                                                <small class="text-muted">
                                                    Posted by {{ $post->personalInfo->first_name }} {{ $post->personalInfo->last_name }} • {{ $post->created_at->diffForHumans() }}
                                                </small>
                                            </div>
                                        ...
                                        <div class="card-body px-4 py-4 bg-light">
                                            ...
                                            @if ($post->image_path)
                                                <div class="text-center">
                                                    <img src="{{ asset('storage/' . $post->image_path) }}" alt="Post Image" class="img-fluid rounded-3 shadow-sm-border border-1" style="max-height: 400px; object-fit: cover;">
                                                </div>
                                            @endif
                                            <br>
                                            <button class="btn btn-sm btn-outline-secondary rounded-pill px-3" onclick="toggleComments(this)">
                                        ...
                                        <div class="comments-section px-4 pb-4 d-none bg-white">
                                            <hr>
                                                ...
                                                <div class="bg-light border-start border-4 border-primary rounded-3 p-3 mb-3">
                                                    ...
                                                    <p class="mb-0">Impressive post! Looking forward to working with you soon.</p>
                                                </div>
                                                <div class="bg-light border-start border-4 border-success rounded-3 p-3">
                                                    ...
                                                    <p class="mb-0">Great experience summary. We'll reach out for an interview.</p>
                                                </div>
                                            </div>
                                    </div>
                                </div>
                                    ...
                                    @foreach ($retrievedPortfolio as $portfolio)
                                        <div class="portfolio-item">
                                            <div class="portfolio-image">
                                                <img src="{{ asset('storage/' . $portfolio->sample_work_image) }}" alt="{{ $portfolio->sample_work_title }}">
                                        ...
                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-center">
                                                    <img id="modalPortfolioImage" src="" class="img-fluid rounded mb-3" alt="Expanded Portfolio Image">
                                        ...
                                        @if ($youtubeID)
                                            <div class="card mb-4 shadow-sm youtube-card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">{{ $yt->description ?? 'No description provided.' }}</p>
                                            ...
                                            <div class="reviewer-info">
                                                <div>
                                                    <h6 class="reviewer-name">
                                                        {{ $rating->personalInfo->first_name ?? 'N/A' }} {{ $rating->personalInfo->last_name ?? '' }}
                                                    </h6>
    ...
    <div class="assessment-card">
        ...
        <div class="decision-tools">
            <div class="assessment-item">
                ...
                <span class="assessment-value excellent">{{ $retrievedProfile->work_background->work_duration ?? 'N/A' }} {{ $retrievedProfile->work_background->work_duration_unit?? 'N/A' }}</span>
            </div>
