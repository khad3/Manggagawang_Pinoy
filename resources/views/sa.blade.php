        ...
        <div class="chat-card">
            ...
            <div class="chat-section">
                ...
                <form id="messageForm" enctype="multipart/form-data" method="POST"
                    action="{{ route('applicant.sendmessage.store') }}">
                    @csrf
                    <div class="message-input" id="messageInput">
                        <div class="input-container d-flex align-items-center gap-2">
                            ...
                            <!-- Message Text Field -->
                            <input type="text" class="message-field flex-grow-1"
                                placeholder="Type your message..." name="message" id="messageField">
    ...
    <script>
        ...
        function displayMessages(friendId) {
            ...
            messages.forEach(msg => {
                ...
                let content =
                    `<div class="p-2 rounded ${msg.sender === "You" ? "bg-primary text-white" : "bg-light"}">`;
                ...
                if (msg.image) {
                    content +=
                        `<img src="/public/uploads/${msg.image}" alt="Image" class="img-fluid mt-1 rounded" style="max-width: 200px;">`;
                }
...
<body>
    ...
    <!-- Main Container -->
    <div class="main-container" <div class="chat-card">
        <!-- Friends Section -->
        <div class="friends-section">
                        ...
                        <a href="?friend_id={{ $friendUser->id }}"
                            ...
                            <div class="friend-details">
                                ...
                                @php
                                    ...
                                    $isOnline =
                                        $lastSeen && \Carbon\Carbon::parse($lastSeen)->gt(now()->subMinutes(10));
                                @endphp
                        ...
                        <div>
                            <h6>
                                <a href="{{ route('applicant.getprofile.display', ['id' => $friendUser->id]) }}">
                                    {{ $friendUser->personal_info->first_name }}
                                    {{ $friendUser->personal_info->last_name }}
                                </a>
                            </h6>
