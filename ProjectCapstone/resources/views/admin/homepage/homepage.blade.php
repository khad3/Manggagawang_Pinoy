    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <section id="officers" class="content-section">
                ...
                <div id="officersList">
                    <!-- Officers will be dynamically populated here -->
                </div>
            </section>
    ...
    <div id="addOfficerModal" class="modal">
        <div class="modal-content">
                ...
                <form id="addOfficerForm">
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" id="officerFirstName" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Last Name</label>
                            <input type="text" class="form-input" id="officerLastName" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group form-grid-full">
                            ...
                            <input type="email" class="form-input" id="officerEmail" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-input" id="officerPassword" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" id="officerStatus" required>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" onclick="submitOfficerForm()">
    ...
    <div id="issueCertificateModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <p class="modal-subtitle">Issue a new TESDA certificate to a qualified individual</p>
                <button class="modal-close" onclick="closeModal('issueCertificateModal')">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            <div class="modal-body">
                <form id="issueCertificateForm">
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" id="certificateRecipient" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Course/Program</label>
                            <select class="form-select" id="certificateCourse" required>
                                ...
                                <option value="Welding NC I">Welding NC I</option>
                                <option value="Food Processing NC II">Food Processing NC II</option>
                                <option value="Beauty Care NC II">Beauty Care NC II</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Assessment Date</label>
                            <input type="date" class="form-input" id="certificateAssessmentDate" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Issue Date</label>
                            <input type="date" class="form-input" id="certificateIssueDate" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Training Center</label>
                            <input type="text" class="form-input" id="certificateTrainingCenter" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Assessment Center</label>
                            <input type="text" class="form-input" id="certificateAssessmentCenter" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Additional Notes</label>
                        <textarea class="form-input" id="certificateNotes" rows="3" placeholder="Any additional notes or remarks..."></textarea>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-cancel" onclick="closeModal('issueCertificateModal')">Cancel</button>
                <button type="submit" class="btn btn-primary" onclick="submitCertificateForm()">
    ...
    <script>
        ...
        let officers = [
            ...
            },
            {
                ...
                region: 'Region VII',
                email: 'roberto.pineda@tesda.gov.ph',
                phone: '+63 922 345 6789',
                employeeId: 'TESDA-R7-032',
                username: 'rpineda',
                accessLevel: 'assessment',
                status: 'inactive',
            ...
            officers.forEach(officer => {
                ...
                officerCard.innerHTML = `
                    ...
                    <div class="officer-actions">
                        <span class="status-badge status-${officer.status}">${officer.status.charAt(0).toUpperCase() + officer.status.slice(1)}</span>
                        <div class="action-buttons">
                            <button class="btn btn-warning btn-sm" onclick="openEditOfficerModal(${officer.id})">
                                <i class="fas fa-edit"></i> Edit
                            </button>
                            <button class="btn btn-danger btn-sm" onclick="deleteOfficer(${officer.id})">
