            ...
            <div class="d-flex align-items-center justify-content-between">
              ...
              <div class="text-center">
                ...
                <div class="mt-2">
                  ...
                  <br /><small class="text-muted d-none d-sm-block"
                    >Position requirements</small
                  >
                </div>
              </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8">
            <div class="card form-card">
              ...
              <form id="preferencesForm" action="{{ route('employer.hiringpreference.store') }}" method="POST">
                  @csrf
                 <div class="tesda-priority">
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="radio" name="tesda_certi_priority" id="tesdaOnly" value="Only consider TESDA-certified workers" required>
                          <label class="form-check-label fw-bold" for="tesdaOnly">  Only consider TESDA-certified workers </label>
                          <div class="text-muted small mt-1"> Strictly filter candidates to only those with valid TESDA certifications </div>
                    </div>

                   <div class="form-check mb-3">
                      <input class="form-check-input" type="radio" name="tesda_certi_priority" id="tesdaPreferred" value="Prefer TESDA-certified but consider others">
                      <label class="form-check-label fw-bold" for="tesdaPreferred"> Prefer TESDA-certified but consider others </label>
                      <div class="text-muted small mt-1"> Prioritize TESDA-certified workers but accept skilled workers with equivalent experience </div>
                    </div>

                   <div class="form-check">
                      <input class="form-check-input" type="radio" name="tesda_certi_priority" id="skillsBased" value="Skills-based evaluation (certification not required)">
                      <label class="form-check-label fw-bold" for="skillsBased"> Skills-based evaluation (certification not required) </label>
                      <div class="text-muted small mt-1"> Evaluate candidates based on practical skills and experience regardless of certification </div>
                    </div>
              </div>
                ...
                <div class="preference-card">
                  ...
                  <div class="timeline-option" onclick="selectTimeline(this, 'immediate')">
                      <div class="form-check">
                          <input
                            ...
                            value="Immediate (within 1 week)"
                          />
                        <label class="form-check-label fw-bold" for="timeline_immediate"> Immediate (within 1 week) </label>
                        <div class="text-muted small"> Urgent requirement - workers needed ASAP </div>
                     </div>
                    </div>
                    ...
                    <div class="timeline-option" onclick="selectTimeline(this, 'soon')">
                        <div class="form-check">
                            ...
                            />
                            <label class="form-check-label fw-bold" for="timeline_soon"> Within 2-4 weeks </label>
                      ...
                      <div class="timeline-option" onclick="selectTimeline(this, 'month')">
                          <div class="form-check">
                              <input
                                ...
                                />
                              <label class="form-check-label fw-bold" for="timeline_month"> Within 1-2 months </label>
                       ...
                       <div class="timeline-option" onclick="selectTimeline(this, 'flexible')">
                          <div class="form-check">
                              <input
                                ...
                                />
                                <label class="form-check-label fw-bold" for="timeline_flexible"> Flexible timeline </label>
                                <div class="text-muted small"> Building a candidate pool for future needs </div>
                            </div>
                        </div>
                    </div>
                  ...
                  <div class="preference-card">
                    ...
                    <div class="row mb-3">
                      <div class="col-md-6">
                        <label for="workersNeeded" class="form-label"
                    ...
                    <div class="mb-3">
                      ...
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          name="worker_experience[]"
                          value="Skilled workers (2-5 years experience)"
                          type="checkbox"
                          id="skilledWorkers"
                        />
                      ...
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          name="worker_experience[]"
                          value="Experienced craftsmen (6+ years experience)"
                          type="checkbox"
                  ...
                  <div class="preference-card">
                    ...
                    <div class="mt-3">
                      <label for="additionalRequirements" class="form-label"
                        >Additional Requirements or Notes</label
                      >
                      <textarea
                        class="form-control"
