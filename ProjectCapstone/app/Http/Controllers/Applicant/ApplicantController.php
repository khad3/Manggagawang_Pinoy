...
public function ViewProfilePage() {
    ...
    return view('applicant.profile.profile' , compact('retrievedProfile' , 'retrievedPosts' , 'retrievedPortfolio' , 'retrievedYoutube'));
}
...
{
    return view('applicant.my_application.applicantion');
}
