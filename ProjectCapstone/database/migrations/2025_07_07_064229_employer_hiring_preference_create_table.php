...
return new class extends Migration
{
    ...
    {
        Schema::create('employer_tesda_certi_priority', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('employer_id');
            $table->unsignedBigInteger('personal_info_id');
            $table->enum('tesda_priority', ['tesda_only', 'tesda_preferred', 'skills_based'])->default('skills_based');
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('employer_tesda_certi_priority');
    }
};
